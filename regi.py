...
def scanners1(url):
    try:
        ...
        for asu in dancok:
            ...
            if ('<title>Laravel</title>' in get_jembut.content.decode('utf-8') or 
                '<title>Register</title>' in get_jembut.content.decode('utf-8') or 
                'name="password_confirmation"' in get_jembut.content.decode('utf-8')):
